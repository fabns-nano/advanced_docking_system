...
void CDockAreaTitleBar::contextMenuEvent(QContextMenuEvent* ev) {
  ...
  if (!isTopLevelArea) {
    ...
    if (CDockManager::testAutoHideConfigFlag(
      ...
      Action = Menu.addAction(isAutoHide ? tr("Unpin (Dock)") : tr("Pin Group"),
  ...
  Action = Menu.addAction(isAutoHide ? tr("Close") : tr("Close Group"), this,
...
CTitleBarButton::CTitleBarButton(bool visible, QWidget* parent)
    : tTitleBarButton(parent),
      Visible(visible),
      HideWhenDisabled(CDockManager::testConfigFlag(
